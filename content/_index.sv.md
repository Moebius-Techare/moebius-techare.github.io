...
Här kan du hitta andra likasinnade eller oliksinnade, som gärna spelar spel, kollar serier i soffan, äter frysmat och som gärna hjälper dig med plugget… så de kan strunta i sitt eget plugg så länge.
...
Studiebevakning handlar om att utöva inflytande för att förbättra studenternas arbetsvillkor. Vi har enligt högskolelagen rätt att vara representerade när beslut fattas. För Möbius innebär det att vi väljer representanter till bland annat kandidatprogramrådet, masterprogramrådet och institutionsstyrelsen.

## Hur ser Möbius studiebevakning ut?

Moebius anordnar två gånger per termin medlemsmöten/studierådsmöten för kandidatstudenter och masterluncher för masterstudenter. Där får man möjlighet att kursutvärdera och välja vilka frågor vi ska driva. Tycker man att en kurs saknas eller att en viss typ av examination borde användas oftare är det på våra medlemsmöten man kan ta upp det så driver vi frågan vidare.
På dessa möten får man även information om vad som händer på universitetet och kåren. För att vi ska kunna studiebevaka är det viktigt att vi får frågor att driva. Om vi inte säger till om vad som kan förbättras är det svårt för universitetet att göra något åt det. Utöver våra möten som är grundverksamheten anordnar vi också pluggfika och plubb. 

Om du har problem med dina kurser är du mer än välkommen att kontakta oss, vi är här för att hjälpa dig!

## Informationskanaler
Vill man ha information om vad det är som sker i och kring Moebius är det bäst att skriva upp sig på Möbius maillista, men det finns även en Facebooksida och en Instagramsida. För biljetter och sånt för event så sker det via Orbi. Är man alumn och inte vill få sin inkorg spammad med mejl så kan man vara med på mejllistan för alumner.
...
Om du har synpunkter om dina studier så kan du kontakta Möbius anonymt (eller inte) via [denna länk](https://forms.gle/iuanD1wckwgoKKAp9).
Styrelsen har en mandatperiod på ett år och väljs på vårmötet i mars eller april och tillträder i början av maj.
...
Moebius tillsätter följande poster i diverse organ.

| Organ                                           | Ordinarie ledamot | Suppleant |
|-------------------------------------------------|-------------------|-----------|
| [Programråd Kandidatprogrammet i matematik](https://www.uu.se/student/institution/matematiska/inflytande-regler-och-rattigheter/programrad)       | 2                 | 1         |
| [Programråd Masterprogrammen i matematik](https://www.uu.se/student/institution/matematiska/inflytande-regler-och-rattigheter/programrad)         | 2                 | 1         |
| [Institutionsstyrelsen matematiska institutionen](https://www.uu.se/institution/matematiska/om-oss/institutionens-styrelse) | 1                 | 0         |
| [Lika villkorsgruppen matematiska institutionen](https://www.uu.se/institution/matematiska/om-oss/arbetsmiljo) | 1                 | 0         |
| [Kårfullmäktige (FUM)](https://utn.se/hur-fungerar-utn)                            | 1                 | 2         |
